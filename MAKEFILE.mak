...
DEP_DEBUG = 
OUT_DEBUG = bin\\Debug\\Blackjack3.exe
...
DEP_RELEASE = 
OUT_RELEASE = bin\\Release\\Blackjack3.exe

OBJ_DEBUG = $(OBJDIR_DEBUG)\\Deck.o $(OBJDIR_DEBUG)\\Game.o $(OBJDIR_DEBUG)\\main.o

OBJ_RELEASE = $(OBJDIR_RELEASE)\\Deck.o $(OBJDIR_RELEASE)\\Game.o $(OBJDIR_RELEASE)\\main.o
...
$(OBJDIR_DEBUG)\\Deck.o: Deck.c
	$(CC) $(CFLAGS_DEBUG) $(INC_DEBUG) -c Deck.c -o $(OBJDIR_DEBUG)\\Deck.o
...
$(OBJDIR_RELEASE)\\Deck.o: Deck.c
	$(CC) $(CFLAGS_RELEASE) $(INC_RELEASE) -c Deck.c -o $(OBJDIR_RELEASE)\\Deck.o
